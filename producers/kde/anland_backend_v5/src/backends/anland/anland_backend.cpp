...
/* -------------------------------------------------------------------------
 * WSLg-style top-level window metadata/control sideband.
 * ANLAND_MULTIWINDOW=1 opts in. This phase mirrors KWin's real window tree
 * without changing the existing full-output dmabuf path, making it safe to
 * deploy before per-window buffer negotiation lands.
 * ------------------------------------------------------------------------- */
